...
class RKColorSettings : ObservableObject {
    ...
    @Published var betweenStartAndEndColor: Color = Color.black
    // background colors
    @Published var textBackColor: Color = Color.clear
    @Published var todayBackColor: Color = Color.gray
    @Published var selectedBackColor: Color = Color.black
    @Published var disabledBackColor: Color = Color.clear
    @Published var betweenStartAndEndBackColor: Color = Color.calendarDateRangeBackground
